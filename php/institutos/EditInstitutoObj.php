            ...
            <div class="col-lg-12">
              <div class="box box-success">
                <div class="box-header with-border">
                  <h3 class="box-title">Edição de instituto</h3>
                </div><!-- /.box-header -->
                <?php
                ...
                <form class="form-horizontal" id="form" method="post" action="CrudInstituto.php">
                  <div class="box-body">
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="instituto" id="nome" value="<?php echo $comp->instituto; ?>" placeholder="Digite aqui" autofocus data-toggle="tooltip" title="Campo Obrigatório!" required>
                        </div>
                      </div>
                  </div><!-- /.box-body -->
                  <div class="box-footer">
                    ...
                    <button type="button" name="cancelar" value="cancelar" onclick="location.href='ViewInstitutosObj.php'" class="btn btn-default btn-flat btn-block btn-sm"><i class="fa fa-undo"></i> Cancelar </button>
                  </div><!-- /.box-footer -->
                </form>
                <?php
                      }
