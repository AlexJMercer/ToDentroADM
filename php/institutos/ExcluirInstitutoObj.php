            ...
            <div class="col-lg-12">
              ...
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Confirmar exclusão do instituto</h3>
                </div><!-- /.box-header -->
                <?php
                  ...
                  <div class="box-body">
                     <div class="form-group">
                        <dl class="dl-horizontal">
                           <dt>Instituto:</dt>
                           <dd><?php echo $comp->instituto; ?></dd>
                        </dl>
                     </div>
                    <form action="CrudInstituto.php" method="post">
                      <input type="hidden" name="id" value="<?php echo $comp->id; ?>"/>
                      <div class="col-sm-6">
                        <button type="submit" name="retornar" value="retornar" class="btn bg-maroon btn-flat btn-block" formaction="ViewInstitutosObj.php"><i class="fa fa-list"></i> Retornar para lista </button>
                      </div>
                      <div class="col-sm-6">
