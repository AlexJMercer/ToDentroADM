            ...
            <div class="col-xs-12">
              <div class="box box-info">
                <div class="box-header">
                  ...
                  <a class="btn btn-info btn-flat pull-right" href="ViewNoticiasStatusObj.php" title="Atualizar resultados" data-toggle="tooltip" data-placement="left"><i class="fa fa-refresh"></i></a>
                </div><!-- /.box-header -->
                <div class="box-body">
                  ...
                  <table id="dataT" class="table table-bordered table-hover dt-responsive nowrap">
                    ...
                    <?php
                      ...
                      $listar = new Noticias();
                      $list   = $listar->ListarNoticiasByStatus();
                    /* echo "<pre>";
                      var_dump($list);
                      echo "</pre>";*/
