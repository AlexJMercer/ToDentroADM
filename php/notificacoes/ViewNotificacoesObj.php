                    ...
                    ?>
                      <tr class="odd gradeX">
                        ...
                        <td>
                          ...
                          <button type="submit" name="excluir" value="excluir" formaction="ExcluirNotificacoesObj.php" class='btn btn-flat btn-danger'><i class="fa fa-times"></i> Excluir </button>
                        </td>
                      </tr>
                      </form>
                      <?php
