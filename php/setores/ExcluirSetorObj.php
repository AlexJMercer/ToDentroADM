            ...
            <div class="col-lg-12">
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Confirmar exclusão do setor</h3>
                </div><!-- /.box-header -->
                <?php
                  ...
                  <div class="box-body">
                     <div class="form-group">
                        <dl class="dl-horizontal">
                           <dt>Setor:</dt>
                           <dd><?php echo $comp->setor; ?></dd>
                           <dt>Descrição:</dt>
                           <dd><textarea class="form-control"  rows="8" cols="40" disabled><?php echo $comp->texto; ?></textarea></dd>
                        </dl>
                     </div>
                    <form action="CrudSetores.php" method="post">
                      <input type="hidden" name="id" value="<?php echo $comp->id; ?>"/>
                      <div class="col-sm-6">
                        <button type="submit" name="retornar" value="retornar" class="btn bg-maroon btn-flat btn-block" formaction="ViewSetoresObj.php"><i class="fa fa-list"></i> Retornar para lista </button>
                      </div>
                      <div class="col-sm-6">
