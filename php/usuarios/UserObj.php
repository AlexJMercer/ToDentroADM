...
else
{
  include '../inc/topo_basic.php';
    ...
    <!--strength-meter-->
    <script src="../../plugins/kartik-v-strength-meter/js/strength-meter.js" type="text/javascript"></script>
    <script src="../../plugins/kartik-v-strength-meter/js/locales/strength-meter-pt-BR.js" type="text/javascript"></script>
    <!-- AdminLTE App -->
